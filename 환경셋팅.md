...
```powershell
uv add langchain langchain-openai langchain-community langgraph faiss-cpu jupyter notebook ipykernel python-dotenv tiktoken rank_bm25 chromadb langchain-chroma flashrank langchain-text-splitters
```
